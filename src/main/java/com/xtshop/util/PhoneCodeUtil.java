...
public class PhoneCodeUtil {
    ...
    public static String readConfigFile(String nameConfig){
        //读取getMessageCode.properties里的配置信息
        if (prop == null) {
            prop = new Properties();
            try {
                //这里的填写的参数是配置文件的相对路径
                ClassPathResource classPathResource = new ClassPathResource("PhoneCode.properties");
                //文件流的编码方式
        ...
        return prop.getProperty(nameConfig);
    }

    public static final String QUERY_PATH = readConfigFile("QUERY_PATH");
    public static final String ACCOUNT_SID = readConfigFile("ACCOUNT_SID");
    public static final String AUTH_TOKEN = readConfigFile("AUTH_TOKEN");
    ...
    public static String getCode(String phone) {
        ...
        String tamp = "【智尚科技】验证码为："+phoneCode+"，您正在操作XTSHOP业务，请确认是本人操作，如不是请忽略此短信。";
